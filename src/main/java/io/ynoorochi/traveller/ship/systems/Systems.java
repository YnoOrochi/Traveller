...
import io.ynoorochi.traveller.ship.systems.Drones.ItemTypes;
...
public class Systems extends Groups {
    ...
    private void otherItems() {
        ...
        addItem(new Drones(ItemTypes.PROBED, 1));
        addItem(new Drones(ItemTypes.ADVPRB, 1));
        addItem(new Drones(ItemTypes.CARGOD, 1));
        addItem(new Drones(ItemTypes.MINING, 1));
        addItem(new Drones(ItemTypes.REPAIR, 1));
